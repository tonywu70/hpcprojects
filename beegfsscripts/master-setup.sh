...
{
	yum -y install wget
    wget -O install_beegfs_mgmt.sh https://raw.githubusercontent.com/azmigproject/BeeGFS/master/beegfs-vmss/install_beegfs_mgmt.sh
    wget -O install_beegfs_client.sh https://raw.githubusercontent.com/azmigproject/BeeGFS/master/beegfs-vmss/install_beegfs_client.sh
